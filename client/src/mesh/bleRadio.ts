// Transport BLE : navigateur ↔ module Meshtastic.
//
 ...
 *
 * Lève `BleUnavailableError` **avant** d'ouvrir quoi que ce soit si la
 * plateforme ne peut pas convenir : sur iOS, `navigator.bluetooth` est
 * simplement absent, et sans cette garde l'appel échouerait sur un
 * `TypeError` incompréhensible pour l'utilisateur.
 */
